...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-950 relative overflow-hidden">
            {/* Background Gradient */}
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-gray-800 via-gray-950 to-black opacity-50 z-0"></div>
            ...
            <div ref={formRef} className="bg-gray-900/80 backdrop-blur-xl p-8 rounded-2xl shadow-2xl w-full max-w-md border border-gray-800 relative z-10">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-gray-400 mt-2">Sign in to continue your research</p>
                </div>
